...
export default defineComponent({
  ...
  setup(props: any, ctx) {
    ...
    const download = async () => {
      ...
      fetch('https://corporatenetbanking.utkarsh.bank/corporate/account/statement/more', {
        headers: {
          accept: '*/*',
        ...
        .then((result) => {
          let body3 = `fromAmount=&accountId=${dataForm.accountId}&accountNumber=${dataForm.accountNumber}&toAmount=&fromDate=${dataForm.fromDate}&toDate=${dataForm.toDate}&monthOf=&noOfTransactions=&format=xlsx&isEmail=false`
          fetch("https://corporatenetbanking.utkarsh.bank/corporate/account/statement/report-statement", {
            "headers": {
              "accept": "*/*",
            ...
            "referrer": "https://corporatenetbanking.utkarsh.bank/corporate/account/statement/start",
            "referrerPolicy": "same-origin",
            "body": body3,
            "method": "POST",
            "mode": "cors",
            ...
            fetch("https://corporatenetbanking.utkarsh.bank/corporate/report-statement/download", {
              "headers": {
